...
dataset <- "0206" # Define the dataset_id
...
data <- mermaid_get_project_data(project = project_id, method = "benthicpit", data = "observations")
...
mermaid_converter_observations(data = data, method = "Point Intercept Transect", dataset = dataset) %>% 
