...
dataset <- "0226" # Define the dataset_id
...
data <- mermaid_get_project_data(project = project_id, method = "benthiclit", data = "observations")
...
mermaid_converter_observations(data = data, method = "Line intercept transect", dataset = dataset) %>% 
