...
dataset <- "0167" # Define the dataset_id
...
data <- mermaid_get_project_data(project = project_id, method = "benthicpqt", data = "sampleevents")
...
mermaid_converter_sampleevents(data, dataset, method = "Photo-quadrat") %>% 
