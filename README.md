...
On the 2023-07-18, the `gcrmndb_benthos` synthetic dataset contains a
total of 804,196 observations (*i.e* rows) representing 9,335 sites and
21,638 surveys.
...
|          ETP |         5 |           5 |            1 |    1998    |   2004    |
|      Pacific |      6102 |       11432 |           25 |    1987    |   2023    |
...
|      Papua New Guinea | Papua New Guinea             |        54 |          70 |            1 |    1998    |   2009    |
...
## 9. Reproducibility parameters
    ...
    other attached packages:
     [1] mermaidr_0.6.4    kableExtra_1.3.4  plotly_4.10.2     rmarkdown_2.23    taxize_0.9.100    leaflet_2.1.2    
     [7] DT_0.28           formattable_0.2.1 knitr_1.43        sf_1.0-14         lubridate_1.9.2   forcats_1.0.0    
    ...
    loaded via a namespace (and not attached):
     [1] tidyselect_1.2.0   viridisLite_0.4.2  farver_2.1.1       fastmap_1.1.1      lazyeval_0.2.2     promises_1.2.0.1  
     [7] digest_0.6.33      timechange_0.2.0   lifecycle_1.0.3    magrittr_2.0.3     compiler_4.3.1     rlang_1.1.1       
    [13] tools_4.3.1        utf8_1.2.3         yaml_2.3.7         data.table_1.14.8  conditionz_0.1.0   htmlwidgets_1.6.2 
    [19] classInt_0.4-9     curl_5.0.1         xml2_1.3.5         KernSmooth_2.23-21 httpcode_0.3.0     withr_2.5.0       
    [25] grid_4.3.1         fansi_1.0.4        e1071_1.7-13       colorspace_2.1-0   extrafontdb_1.0    scales_1.2.1      
    [31] iterators_1.0.14   crul_1.4.0         cli_3.6.1          crayon_1.5.2       ragg_1.2.5         generics_0.1.3    
    [37] rstudioapi_0.15.0  httr_1.4.6         tzdb_0.4.0         DBI_1.1.3          ape_5.7-1          proxy_0.4-27      
    [43] rvest_1.0.3        parallel_4.3.1     s2_1.1.4           vctrs_0.6.3        webshot_0.5.5      jsonlite_1.8.7    
    [49] hms_1.1.3          systemfonts_1.0.4  crosstalk_1.2.0    foreach_1.5.2      units_0.8-2        glue_1.6.2        
    [55] codetools_0.2-19   stringi_1.7.12     gtable_0.3.3       later_1.3.1        munsell_0.5.0      pillar_1.9.0      
    [61] htmltools_0.5.5    R6_2.5.1           wk_0.7.3           textshaping_0.3.6  bold_1.3.0         evaluate_0.21     
    [67] lattice_0.21-8     httpuv_1.6.11      class_7.3-22       Rcpp_1.0.11        uuid_1.1-0         svglite_2.1.1     
    [73] nlme_3.1-162       Rttf2pt1_1.3.12    xfun_0.39          zoo_1.8-12         pkgconfig_2.0.3   
