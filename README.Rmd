...
read.csv2("data/05_data-sources.csv") %>%
  ...
  mutate(datasetID = str_pad(datasetID, width = 4, side = "left", pad = "0"),
         modified = as.character(as_date(modified, format = "%d/%m/%Y")),
         modified = replace_na(modified, ""),
         ...
         type = str_replace_all(type, c("article" = "Ar.",
                                        ...
                                        "data repository" = "Rp.",
                                        "data sharing" = "Sh."))) %>% 
  mutate(rightsHolder = str_replace_all(rightsHolder, "C2O Pacific", "C~2~O Pacific")) %>% 
...
devtools::session_info(c("tidyverse", "formattable", "DT", "leaflet",
                         "taxize", "sf", "knitr", "rmarkdown", "plotly", "kableExtra", "mermaidr"))
